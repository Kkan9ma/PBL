...
export const getCommandCategory = (command) => {
  return Object.keys(EntireCommandsMap).find((commandMap) =>
...
export const textPropertyCommands = Object.keys(
  EntireCommandsMap['textProperty'],
);
export const documentElementCommands = Object.keys(
  EntireCommandsMap['documentElement'],
);
