...
import { StyledModalAssetContainer } from "./ModalAssetContainer.styles";

function ModalAssetContainer() {
  return (
    <StyledModalAssetContainer>
      <label htmlFor="music-file">
        음악 파일
        {/* <input id="music-file" name="music-file" type="button" /> */}
        <button type="button" name="music-file" id="music-file">
          <svg
...
export default ModalAssetContainer;
